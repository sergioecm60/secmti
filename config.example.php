...
return array (
  ...
  // ============================================================================
  'app' => array(
    // La URL base de la aplicación. Se recomienda encarecidamente establecerla en tu archivo .env
    'url' => $_ENV['APP_URL'] ?? 'http://localhost',
    'timezone' => 'America/Argentina/Buenos_Aires', // Importante para logs y fechas
  ),
  ...
  // ============================================================================
  'landing_page' => array (
    'company_name' => $_ENV['APP_NAME'] ?? 'Portal de Servicios',
    'logo_path' => $_ENV['APP_LOGO_PATH'] ?? 'assets/images/logo.png',
    
    'sales_title' => 'Contacto',
    'phone_numbers' => array (
      // Se gestiona en .env con PHONE_NUMBERS (separado por comas)
    ),
    
    'locations_title' => 'Sucursales',
    'branches' => array (
      // Se gestiona en .env con BRANCHES (separado por comas)
    ),
    
    'social_title' => 'Encontranos en:',
    'social_links' => array (
      // Se gestiona en .env con variables como SOCIAL_FACEBOOK_URL, etc.
      'facebook' => array (
        'label' => 'Facebook',
        'url' => $_ENV['SOCIAL_FACEBOOK_URL'] ?? '#',
  ...
  'footer' => array (
    ...
    'whatsapp_number' => $_ENV['WHATSAPP_NUMBER'] ?? '',  // Se gestiona en .env
