...
CREATE TABLE IF NOT EXISTS `dc_servers` (
  ...
  `type` ENUM('physical','virtual','container','cloud') COLLATE utf8mb4_spanish_ci DEFAULT 'physical',
...
CREATE TABLE IF NOT EXISTS `dc_credentials` (
  ...
  `password` VARCHAR(500) COLLATE utf8mb4_spanish_ci NOT NULL COMMENT 'IMPORTANTE: Guardar en texto plano. Para mayor seguridad, considere encriptación AES a nivel de BD, no hashing.',
